...
export const SopModal = ({ isOpen, onClose, serviceName, sopFileName, fileUrl }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-900/70 backdrop-blur-xs flex items-center justify-center p-3 sm:p-6 overflow-y-auto animate-in fade-in duration-200">
      <div 
        className="relative w-full max-w-5xl bg-white rounded-3xl shadow-2xl border border-slate-200 overflow-hidden text-left flex flex-col max-h-[92vh]"
      ...
      >
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100 bg-slate-50/90 shrink-0">
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <p className="text-xs text-slate-500 font-semibold flex items-center gap-2 mt-0.5 truncate">
                <span className="font-mono bg-sky-50 text-sky-700 px-2 py-0.5 rounded border border-sky-200 text-[11px] font-bold">
                  {resolvedFileName}
                </span>
          ...
          <div className="flex items-center gap-2 shrink-0">
            <a
              ...
              className="hidden sm:inline-flex items-center gap-1.5 px-3 py-1.5 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-xl text-xs font-bold transition-all shadow-2xs cursor-pointer"
            ...
            <a
              ...
              className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-sky-600 hover:bg-sky-700 text-white rounded-xl text-xs font-bold transition-all shadow-xs cursor-pointer"
            ...
            <button
              type="button"
              onClick={onClose}
              className="w-9 h-9 rounded-xl hover:bg-slate-200/80 text-slate-400 hover:text-slate-700 flex items-center justify-center transition-all cursor-pointer ml-1"
            >
              <X className="w-5 h-5" />
            </button>
          </div>
        ...
        <div className="p-4 sm:p-6 flex-1 min-h-[380px] bg-slate-100/60 overflow-hidden flex flex-col">
          <iframe
            src={resolvedUrl}
        ...
        <div className="px-6 py-3.5 bg-slate-50 border-t border-slate-200 flex items-center justify-between gap-3 shrink-0 flex-wrap text-xs">
          ...
          <button
            type="button"
            onClick={onClose}
            className="px-5 py-2 bg-slate-200 hover:bg-slate-300 text-slate-700 rounded-xl text-xs font-bold transition-all cursor-pointer ml-auto"
          >
            Tutup Pratinjau
          </button>
        </div>
